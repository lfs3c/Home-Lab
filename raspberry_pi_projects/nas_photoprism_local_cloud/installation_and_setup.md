...
This system is **production‑stable** for home use. You need to create a frequent backup routine, just in case something goes wrong with it, so you don't lose your files/images
